...
exports.distillToWorkspace = distillToWorkspace;
exports.distillToPersonal = distillToPersonal;
 ...
 */
function makePersonalApiLLM(apiKey) {
    return async (prompt) => {
        const response = await fetch('https://api.anthropic.com/v1/messages', {
            method: 'POST',
            headers: {
 ...
 */
async function distillToWorkspace(memories, apiKey, llm) {
 ...
 */
async function distillToPersonal(memories, existingPersona, apiKey, llm) {
    if (!apiKey) {
        return '';
    }
